...
namespace F1
{
    public partial class Form24 : Form
    {
        ...
        private void Form24_Load(object sender, EventArgs e)
        {
            ...
            if (File.Exists(path_desktop + "\\F1\\2022\\Circuite\\" + Form21.traseu_selectat + "\\" + "Rezultate" + ".txt"))
            {
                pictureBox4.Dispose();
                string[] lines = System.IO.File.ReadAllLines(path_desktop + "\\F1\\2022\\Circuite\\" + Form21.traseu_selectat + "\\" + "Rezultate" + ".txt");
                ...
                nume_pilot = "Piastri.png";
                img = System.Drawing.Image.FromFile(string.Concat(path, nume_pilot));
                b = new Bitmap(img);
                i = resizeImage(b, new Size(1000, 1000));
                imageList2.Images.Add(i);

                nume_pilot = "DeVries.png";
                img = System.Drawing.Image.FromFile(string.Concat(path, nume_pilot));
                b = new Bitmap(img);
                i = resizeImage(b, new Size(1000, 1000));
                imageList2.Images.Add(i);
